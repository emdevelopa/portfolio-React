        ...
        <>
            <Box marginTop={10}>
                <Stack alignItems='center' rowGap={2}>
                    ...
                    <Stack direction={"row"} bgcolor='red' width='100%' justifyContent={"space-between"}>
                        <Box width='100%' bgcolor='blue' paddingX={5}>
                            <Typography variant="h5" fontWeight={800}>Get to know me!</Typography>
